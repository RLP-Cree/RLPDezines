...
exports.handler = async (event) => {
    try {
        ...
        if ((payload.type === 'payment.updated' || payload.type === 'payment.created') && payload.data.object.payment.status === 'COMPLETED') {
            ...
            // ── PREMIUM ORDER CONFIRMATION EMAIL GENERATOR ──
            try {
                // Dynamically map out items for a high-end HTML invoice table
                ...
                // Parse financial layers directly from Square Order totals
                ...
                // Deduct shipping/tax from grand total to safely present item subtotal
